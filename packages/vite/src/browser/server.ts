...
import { spaFallbackMiddleware } from '../node/server/middlewares/spaFallback'
...
import { errorMiddleware, prepareError } from '../node/server/middlewares/error'
import type { HmrOptions } from '../node/server/hmr'
import { handleFileAddUnlink, handleHMRUpdate } from '../node/server/hmr'
